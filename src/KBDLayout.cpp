...
const std::unordered_map<std::string, int> keyToVK = {
    ...
    { "KEY_KEMPSTON2_RIGHT", fabgl::VK_KEMPSTON2_RIGHT },
    { "KEY_KEMPSTON2_LEFT", fabgl::VK_KEMPSTON2_LEFT },
    { "KEY_KEMPSTON2_DOWN", fabgl::VK_KEMPSTON2_DOWN },
    { "KEY_KEMPSTON2_UP", fabgl::VK_KEMPSTON2_UP },
    { "KEY_KEMPSTON2_FIRE", fabgl::VK_KEMPSTON2_FIRE },
    { "KEY_KEMPSTON2_ALTFIRE", fabgl::VK_KEMPSTON2_ALTFIRE },
